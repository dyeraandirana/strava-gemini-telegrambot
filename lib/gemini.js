...
export async function analyzeActivities(activities, athleteName = "") {
  ...
  const prompt = `
namaku ${athleteName}, kamu berperan sebagai coach lariku ya!
3 latihan terakhir ku gini nih. 
${JSON.stringify(activities, null, 2)}

rekap dan analisis hasil latihannya, evaluasi HR, pace dsb. beri saran latihan berikutnya kira-kira seperti apa
